        ...
        return (
            <div>
                <button onClick={this.decrease}
                        disabled={this.props.cnt === this.props.min || this.props.disable}
                >
                    -
                </button>
                <AppLazyInput
                    nativeProps={{type: 'text', className: styles.input,disabled: this.props.disable}}
                ...
                <button onClick={this.increase}
                        disabled={this.props.cnt === this.props.max || this.props.disable}
                >
                    +
                </button>
            </div>
